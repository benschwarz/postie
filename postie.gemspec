...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/models", "lib/models/locality.rb", "lib/models/state.rb", "lib/postie.rb", "test/postcode_test.rb", "test/test_helper.rb", "LICENSE"]
  s.has_rdoc = true
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dm-serializer>, [">= 0.9.8"])
